...
$sbs01 = $_POST['T64'];
$sbs02 = utf8_decode($_POST['T65']);
$sbs03 = utf8_decode($_POST['T66']);
$sbs04 = utf8_decode($_POST['T67']);
$sbs05 = utf8_decode($_POST['T70']);
$sbs06 = $_POST['T71'];
$sbs07 = $_POST['T72'];
$sbs08 = $_POST['T73'];
$sbs09 = $_POST['T74'];
...
$sql= "INSERT INTO proceso11.ds_rom (id, a_paterno, a_materno, nombres, nom_complet, estudios, ciudad, estado, " .
  ...
  "sub_cedprof, sub_hosp, sub_ciudad, sub_pais, sub_instrecon, sub_inicia, sub_fin, sub_promesp, sub_lugobten, sbs_folio, sbs_vigencia )" . 
"values ($ctt1, '$rvd1', '$vod2', '$vod3', '$nomc', '$vod5', '$vod6', '$vod7', " . 
  ...
  "'$sbs01', '$sbs02', '$sbs03', '$sbs04', '$sbs05', '$sbs06', '$sbs07', '$sbs08', '$sbs09', '$sbs11', '$sbs12')"; 
